...
$(document).ready(function() {
	...
	const o = "avatarTpl/",
		l = ".png";
	var c, d, s;
	$(".jumbotron .btn-tpl:not(.disabled)").each(function() {
		var e = $(this).html(),
			t = o + e + l;
		$(this).css("background-image", "url(" + t + ")")
	}), $(".jumbotron button:not(.disabled)").click(function() {
		$("#avatarPreview").attr("src", null), $("#avatarPreview").attr("alt", "\u6a21\u677f\u8f7d\u5165\u4e2d"), c = $(this).html(), d = o + c + l, s = e(d), s.onload = function() {
			$("#avatarPreview").attr("src", s.src)
		}, $("#imgSpace").removeClass("hidden"), document.getElementById("step1").scrollIntoView()
		...
		if (!$(this).hasClass("disabled")) {
			...
			v.src = m.toDataURL(""), $("#outputSpace").removeClass("hidden"), document.getElementById("step3").scrollIntoView();
			$('#footer').show();
		}
	})
});
